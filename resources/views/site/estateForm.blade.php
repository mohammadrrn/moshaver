    ...
    <main class="container-fluid">
        ...
        <div class="container main-box-top">
            <form class="row send-product" method="post" action="{{route('request.estate')}}">
                ...
                <div class="col-12 col-md-6 view-order">
                    <div class="group">
                        <input type="text" name="plaque" value="{{old('plaque')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>پلاک</label>
                    </div>
                ...
                <div class="col-12 col-md-6 view-order">
                    <div class="group">
                        <input type="text" name="owner_mobile_number" value="{{old('owner_mobile_number')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div id="box-by" class="col-12 view-order">
                    <div class="group">
                        <input type="text" id="buy_price" name="buy_price" value="{{old('buy_price')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div id="box-rent" class="col-12 view-order">
                    <div class="group">
                        <input type="text" name="rent_price" id="rent_price" value="{{old('rent_price')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-12 col-md-6 view-order">
                    <div class="group">
                        <input type="text" name="number_of_floor" value="{{old('number_of_floor')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-12 col-md-6 view-order">
                    <div class="group">
                        <input type="text" name="apartment_unit" value="{{old('apartment_unit')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-12 col-md-6 view-order">
                    <div class="group">
                        <input type="text" name="number_of_room" value="{{old('number_of_room')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-12 col-md-6 view-order">
                    <div class="group">
                        <input type="text" name="year_of_construction" value="{{old('year_of_construction')}}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
