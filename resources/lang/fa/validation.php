...
return [
    ...
    */
    ...
    'confirmed' => 'کلمه عبور و تکرار کلمه عبور با هم یکسان نمی باشد',
    ...
    'email' => 'فیلد ایمیل نامعتبر می باشد',
    ...
    'not_regex' => 'فرمت فیلد :attribute نامعتبر می باشد',
    'numeric' => 'فیلد :attribute باید به صورت عددی وارد شود',
    'password' => 'The password is incorrect.',
    'present' => 'The :attribute field must be present.',
    'regex' => 'فرمت فیلد :attribute نامعتبر می باشد',
    ...
    'string' => 'فرمت فیلد :attribute به صورت متنی می باشد',
    ...
    */
    ...
    'attributes' => [
        ...
        'real_estate_name' => 'نام املاک',
        'score' => 'امتیاز',
        'code' => 'کد احراز هویت',
        'area_id' => 'منطقه',
        'area' => 'متراژ',
        'national_code' => 'کد ملی',
        'type_of_transfer' => 'نوع واگذاری',
        'type_of_estate' => 'نوع ملک',
        'range_of_address' => 'حدود آدرس',
        'rang_of_area' => 'حدود متراژ درخواستی',
        'buy_price' => 'مبلغ خرید',
        'mortgage_price' => 'مبلغ رهن',
        'rent_price' => 'مبلغ اجاره',
        'description' => 'توضیحات',
        'owner_name' => 'نام مالک',
        'owner_mobile_number' => 'شماره همراه مالک',
        'transfer_id' => 'نوع واگذاری',
        'estate_id' => 'نوع ملک',
        'address' => 'آدرس',
        'street_name' => 'نام کوچه و خیابان',
        'plaque' => 'پلاک',
        'floor' => 'طبقه',
        'number_of_floor' => 'تعداد طبقات',
        'number_of_room' => 'تعداد اتاق ها',
        'apartment_unit' => 'تعداد واحد ها',
        'year_of_construction' => 'سال ساخت',
        'direction_id' => 'جهت ملک',
        'zoonkan_name' => 'نام زونکن',
