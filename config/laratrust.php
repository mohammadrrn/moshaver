...
return [
    ...
    */
    ...
    | administration estateRequest to attach roles and permissions to the users.
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Section to manage everything related with the estateRequest estateRequest for the roles and permissions.
    |
    */
    'estateRequest' => [
        /*
        ...
        |--------------------------------------------------------------------------
        |
        | This manages if routes used for the estateRequest estateRequest should be registered.
        | Turn this value to false if you don't want to use Laratrust estateRequest estateRequest
        |
        */
        'register' => false,
        ...
        |--------------------------------------------------------------------------
        |
        | This is the URI path where Laratrust estateRequest for roles and permissions
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | These middleware will get attached onto each Laratrust estateRequest route.
        |
        */
        'middleware' => ['web'],
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Add restriction to roles in the estateRequest
        |--------------------------------------------------------------------------
        |
